...
export type MyTaskDetailsScreenProps = NavigationScreenProp<{}>

export const MyTaskDetailsScreen: React.FunctionComponent<MyTaskDetailsScreenProps> = observer(
  (props: MyTaskDetailsScreenProps) => {
    ...
    return (
      <View style={styles.screen} testID="MyTaskDetailsScreen">
